...
exports["default"] = convertToJsonLegacyBehavior;
var _convertToJson = _interopRequireDefault(require("./convertToJson.js"));
...
function convertToJsonLegacyBehavior(data, schema) {
  ...
  var result = (0, _convertToJson["default"])(data, schema, _objectSpread(_objectSpread({}, defaultConversionOptions), {}, {
    rowIndexMap: rowMap,
